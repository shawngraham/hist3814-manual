...
Let's take a look at the [rubric and assessment and assignments](/rubric) right now.

<!--chapter:end:1-about.rmd-->

# Rubric and Assessment

By the end of this course, you should be able to do the following:

1. Understand how to use the idea of '[the productive fail](/productivefail)' to use computing power effectively as an historian;
...
**Unacknowledged help or unacknowledged collaborative work will be grounds for unsatisfactory work.**
...
Your final project will take as its source material some 1500 editions of The Shawville Equity, an English newspaper published in Western Quebec, from 1883 to the present day. Begin thinking now about the kinds of history or the historical questions for which such information might be suitable.

Paradata' is a description of the 'how' and 'why' of what you're doing (see also the 'when things go wrong' section on the [detailed instructions](/finalproject)). A formal discussion of what paradata do from the [London Charter](http://www.londoncharter.org/introduction.html):
...
- Principles of open access research and your digital identity
- Finding Data
- ‘Wrangling’ Data, or getting it into useable shape
- First Questions, or where are the holes and assumptions in your data?
- Analyzing data, or matching the appropriate tool to the question
- Visualizing (graphing, writing, plotting, mapping) data patterns, or communicating the compelling story
...
Make sure you've taken a glance at the [Final Project detailed instructions](/finalproject), then let's get your computer [set up](/machinesetup).

<!--chapter:end:2-rubric.rmd-->
...
See the tools and techniques in the final two modules of the [workbook](http://craftingdigitalhistory.ca) for inspiration; make sure your visual styling supports the key themes and ideas your research is exploring.
...
Per Appleford, Simon, and Jennifer Guiliano, 'Best Practice Principles Of Designing Your First Project.' DevDH.org, 2013, [http://devdh.org/lectures/design/bestpractice/](http://devdh.org/lectures/design/bestpractice/), the components of a project are the:
...
<!--chapter:end:3-finalproject.rmd-->
...
Now, please read the [code of conduct](/codeofconduct)

<!--chapter:end:4-machinesetup.rmd-->
...
This concludes the syllabus. Here may be found the official Carleton U statements on [plagiarism, accommodations, etc.](/regs).

Now, before you turn to the [workbook](http://workbook.craftingdigitalhistory.ca), do read the essay on '[failing productively](/productivefail)'. 

<!--chapter:end:5-codeofconduct.rmd-->
...
_in contrast to the official language to be used, I instead release this work:_
 <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><br />This work is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>._
...
_[please see my own code of conduct for this class](/codeofconduct)_
...
The last date to withdraw without financial penalty late Summer term courses is July 24, 2017.
...
<!--chapter:end:7-questionnaire.rmd-->
